...
function ReviewForm({ book, open, onClose, onSubmit, reviewId = null}) {
  ...
  const dialogProps = {
    ...
    delete: {
      ...
      description: 'Tem certeza que deseja remover esta review? Esta ação é irreversível.',
      confirmText: 'Remover',
    },
          ...
          <Box sx={{ p: 2, display: 'flex', flexDirection: 'row', alignItems: 'top', gap: 3 }}>
            ...
            <Box sx={{ width: '100%'}}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                  <Typography variant="body1">Read it on</Typography>
                  <StyledDate
                    type="date"
                    value={readDate}
              ...
              <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-start'}}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <Typography variant="h5" fontSize="0.9em">Favorite</Typography>
